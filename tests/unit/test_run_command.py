...
class TestRunKeyboardInterrupt:
    ...
    def test_keyboard_interrupt_during_claude_step_returns_nonzero(
        self,
        mock_deps: MagicMock,
        mock_log_execution: MagicMock,
        mock_pr_detector: MagicMock,
        ...
        """KeyboardInterrupt during ClaudeRunner.run causes _run_workflow to return non-zero."""
        with patch(f"{_MOD}.ClaudeRunner") as cls:
            instance = MagicMock()
    ...
    def test_keyboard_interrupt_during_8moku_returns_nonzero(
        self,
        mock_deps: MagicMock,
        mock_runner: MagicMock,
        mock_log_execution: MagicMock,
        ...
        """KeyboardInterrupt during 8moku subprocess causes _run_workflow to return non-zero."""
